...
public class AppMsg {
	 ...
	 * style.
	 */
	public static final Style STYLE_ALERT = new Style(LENGTH_LONG, R.color.transparent_red);

	/**
	 * Show the text notification for a short period of time with a positive
	 * style.
	 */
	public static final Style STYLE_CONFIRM = new Style(LENGTH_SHORT, R.color.transparentBlack);

	/**
	 * Show the text notification for a short period of time with a neutral
	 * style.
	 */
	public static final Style STYLE_INFO = new Style(LENGTH_SHORT, R.color.transparentBlack);
	 ...
	 * 
	 * @param context
	 *            The context to use. Usually your {@link Activity}
	 *            object.
	 */
	...
	public static AppMsg makeText(Activity context, CharSequence text, Style style) {
		// if (com.twj.moments.utils.OtherUtils.isLollipop())
		// return makeText(context, text,
		// new Style(LENGTH_SHORT, context.getResources()
		// .getColor(Color.parseColor(new
		// AppPreference(context).getSettingPref()
		// .getString(Keys.USER_KEYS.themeColor, "#00D1CE")),
		// context.getTheme())),
		// R.layout.app_msg);
		// else
	...
	/**
	 * @author mengguoqiang 扩展支�?设置字体大�? Make a
	 *         {@link AppMsg} that just contains a text view.
	 * 
	 * @param context
	 *            The context to use. Usually your {@link Activity}
	 *            object.
	...
	/**
	 * @author mengguoqiang 扩展支�?字体大�? Make a {@link AppMsg}
	 *         with a custom layout. The layout must have a {@link TextView} com
	 *
	 * @param context
	 *            The context to use. Usually your {@link Activity}
	 *            object.
	 ...
	 * 
	 * @author mengguoqiang 扩展支�?设置字体大�? Make a
	 *         {@link AppMsg} with a custom view. It can be used to create
	 *         non-floating notifications if floating is false.
	 * 
	 * @param context
	 *            The context to use. Usually your {@link Activity}
